<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <legend>
        ...
        <div class="row breadcrumb" >
            ...
            <div class="col-md-2">
                <a class="btn btn-primary" href="<?= base_url('Aluno/lista/' . $aplicatividade) ?>">Voltar</a>
            </div>
            <div class="col-md-10">
            </div>
        </div>
    ...
    <div class="container">
        <form  method="POST" action="<?= site_url('Aluno/inserir/') ?>"> 
            <input type="hidden" value="<?=$aplicatividade?>" name="idaplicaatividade">
